                    ...
                    <div class="col-6 offset-3">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <input type="email" class="form-control" id="email" name="uemail" placeholder="email" value="">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" id="pwd" name="upassword" placeholder="mot de passe" value="">
                            </div>
                            <!--                    </div>-->
                            <!--                </div>-->
