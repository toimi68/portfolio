    ...
    <div class="container-fluid">
        <header>
            <nav class="nav nav-pills flex-column flex-sm-row mb-5">
                <a class="flex-sm-fill text-sm-center nav-link btn-outline-primary" href="?gestion=competence">Gestion
                    des competences</a>
                <!-- <a class="flex-sm-fill text-sm-center nav-link btn-outline-info text-dark" href="?gestion=projet">Gestion
                    des projets</a> -->
                <a class="flex-sm-fill text-sm-center nav-link btn-outline-primary" href="?gestion=experience">Gestion
                    des experiences</a>
                <a class="flex-sm-fill text-sm-center nav-link btn-outline-primary" href="?gestion=formation">Gestion
                    des
                    formations</a>
